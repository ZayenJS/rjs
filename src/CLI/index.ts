...
class CLI extends Command {
  ...
  public getPackageName(type: 'long' | 'short' | 'rc') {
    ...
    const shortName = this._packageNameLong;
  ...
  private _registerConfigCommand() {
    this.command('config')
      ...
      .option('-t, --typescript', `If true, the components generated by "${this._packageNameLong}" will use typescript`)
